	...
	<div id="main">
		<!-- 캐러셀 -->	
		 <div id="carousel_section">
	        <ul>
	            <li style="background-color : green;"> <img src=""> </li>
	            <li style="background-color : gray;"> <img src=""> </li>
	            <li style="background-color : blue"> <img src=""> </li>
	            <li style="background-color : pink"> <img src=""> </li>
	        </ul>
	    </div>	
